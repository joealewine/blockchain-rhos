...
| **Kubernetes v1.11 and higher** | <ul><li>x86_64. The platform has also been tested on Rancher and Azure Kubernetes Service (AKS).</li></ul> | <ul><li>Rancher v2.3.2</li><li>Azure Kubernetes Service (AKS)</li></ul>|
