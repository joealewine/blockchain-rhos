...
If you are an existing {{site.data.keyword.blockchainfull_notm}} Platform v2.1.0 customer, there is no upgrade needed to the {{site.data.keyword.blockchainfull_notm}} Platform v2.1.1.
{: note}
